...
const InfoButton = () => {
  ...
  return (
    <div className='pt-5 mt-5 text-center regularText'>
      {infoButtonState ? (
        <svg
        ...
        <div>
          <div className='row'>
            <div className='col-12 text-center'>{GAME_INFO_1}</div>
          </div>
          <div className='row'>
            <div className='col-12 text-center'>{GAME_INFO_2}</div>
          </div>
        </div>
      )}
    </div>
